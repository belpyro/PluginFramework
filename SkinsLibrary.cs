...
namespace PluginFramework
{
    public static class SkinsLibrary
    {
        ...
        /// </summary>
        public static Boolean _Initialized { get; private set; }
        ...
        /// </summary>
        public static GUISkin CurrentSkin { get { return _CurrentSkin; } }
        ...
        /// </summary>
        public static GUIStyle CurrentTooltip { get { return _CurrentTooltip; } }

        /// <summary>
        /// Heres where we store the list of custom skins
        /// </summary>
        public static Dictionary<String, GUISkin> List { get; set; }

        /// <summary>
        /// Sets up the default skins and associated bits - only needs to run once in OnGUI code
        /// </summary>
        public static void InitSkinList()
        {
            if (!_Initialized)
            {
        ...
        public static void SetCurrent(DefSkinType DefaultSkin)
        {
        ...
        public static GUISkin CopySkin(DefSkinType DefaultSkin)
        {
            switch (DefaultSkin)
            {
        ...
        public static void AddSkin(String SkinID, GUISkin NewSkin, Boolean SetAsCurrent = false)
        {
            NewSkin.name = SkinID;
            if (List.ContainsKey(SkinID))
                List[SkinID] = NewSkin;
        ...
        public static Boolean RemoveSkin(String SkinID)
        {
        ...
        public static Boolean SkinExists(String SkinID)
        {
        ...
        public static void AddStyle(String SkinId, String StyleID, GUIStyle NewStyle)
        {
        ...
        /// <param name="SkinID">The string ID of the custom skin</param>
        /// <param name="NewStyle">The New GUIStyle to Add to the Skin</param>
        public static void AddStyle(String SkinId, GUIStyle NewStyle)
        {
        ...
        /// <param name="StyleID">The string ID of the custom style</param>
        /// <param name="NewStyle">The New GUIStyle to Add to the Skin</param>
        public static void AddStyle(DefSkinType DefaultSkin, String StyleID, GUIStyle NewStyle)
        {
            NewStyle.name = StyleID;
        ...
        /// <param name="StyleID">The string ID of the custom style</param>
        /// <param name="NewStyle">The New GUIStyle to Add to the Skin</param>
        public static void AddStyle(DefSkinType DefaultSkin, GUIStyle NewStyle)
        {
            GUISkin skinTemp;
        ...
        /// <param name="SkinID">The string ID of the custom skin</param>
        /// <param name="StyleID">The string ID of the custom style</param>
        public static void RemoveStyle(String SkinID, String StyleID)
        {
            if (SkinExists(SkinID))
            {
                GUISkin skinTemp = List[SkinID];
        ...
        /// <param name="DefaultSkin">Which predefined skin to use</param>
        /// <param name="StyleID">The string ID of the custom style</param>
        public static void RemoveStyle(DefSkinType DefaultSkin, String StyleID)
        {
            GUISkin skinTemp;
            if (DefaultSkin == DefSkinType.KSP)
                skinTemp = DefKSPSkin;
        ...
        public static Boolean StyleExists(String SkinID, String StyleID)
        {
        ...
        public static Boolean StyleExists(DefSkinType DefaultSkin, String StyleID)
        {
            if (DefaultSkin == DefSkinType.KSP)
        ...
        public static void AddStyle(ref GUISkin SkinToAction, String StyleID, GUIStyle NewStyle)
        {
        ...
        /// <param name="SkinToAction">The GUISkin we are going to adjust. The name of the Style is its ID</param>
        /// <param name="NewStyle">The GUIStyle to add or update</param>
        public static void AddStyle(ref GUISkin SkinToAction, GUIStyle NewStyle)
        {
        ...
        /// <param name="StyleID">The string ID of the custom style</param>
        public static void RemoveStyle(ref GUISkin SkinToAction, String StyleID)
        {
        ...
        public static GUIStyle GetStyle(GUISkin SkinToAction, String StyleID)
        {
            if (StyleExists(SkinToAction, StyleID))
        ...
        /// <param name="StyleID">The string ID of the custom style</param>
        /// <returns>whether it exists or not</returns>
        public static Boolean StyleExists(GUISkin SkinToAction, String StyleID)
        {
