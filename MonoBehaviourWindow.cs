...
namespace PluginFramework
{
    ...
    public abstract class MonoBehaviourWindow : MonoBehaviourExtended
    {
        ...
        private void DrawGUI()
        {
            ...
            if (WindowStyle == null)
            {
                WindowRect = GUILayout.Window(WindowID, WindowRect, DrawWindowpublic, WindowCaption, WindowOptions);
            }
            else
            {
                WindowRect = GUILayout.Window(WindowID, WindowRect, DrawWindowpublic, WindowCaption, WindowStyle, WindowOptions);
            }
        ...
        /// </summary>
        public TimeSpan DrawWindowpublicDuration { get; private set; }
        ...
        private void DrawWindowpublic(Int32 id)
        {
            ...
            DrawWindowpublicDuration = (DateTime.Now - Duration);
        }
